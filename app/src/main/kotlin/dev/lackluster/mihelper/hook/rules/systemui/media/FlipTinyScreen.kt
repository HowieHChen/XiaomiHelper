        ...
        HostExecutor.execute(
            ...
            backgroundTask = {
                ...
                if (colorOpt) {
                    ...
                    holder.lightMediaBgColor = ambientColor ?: Color.TRANSPARENT
                    holder.darkMediaBgColor = ambientColor ?: Color.TRANSPARENT
                    mainColorHCT = ambientColor ?: Color.TRANSPARENT
                } else {
