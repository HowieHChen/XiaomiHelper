        ...
        onAppLifecycle {
            onCreate {
                if (!isInitialized) {
                    ...
                    recents_quick_switch_left_exit = this.getResID("status_bar_recent_memory_info2", "anim", PKG_NAME)
                    recents_quick_switch_right_enter = this.getResID("status_bar_recent_memory_info2", "anim", PKG_NAME)
                    recents_quick_switch_right_exit = this.getResID("status_bar_recent_memory_info2", "anim", PKG_NAME)
