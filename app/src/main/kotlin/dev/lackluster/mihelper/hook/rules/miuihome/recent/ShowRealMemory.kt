...
//            }
            recentContainerClass.toClass().method {
                ...
                before {
                    ...
                    }.cast<TextView>()?.text = context.getString(status_bar_recent_memory_info1, availMem, totalMem)
                    this.instance.current().field {
                        name = "mTxtMemoryInfo2"
                    }.cast<TextView>()?.text = context.getString(status_bar_recent_memory_info2, availMem, totalMem)
                }
            }
        }
    }
