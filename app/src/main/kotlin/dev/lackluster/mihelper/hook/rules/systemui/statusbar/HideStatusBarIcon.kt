...
object HideStatusBarIcon : YukiBaseHooker() {
    ...
    private val hideMobile = Prefs.getInt(IconTurner.MOBILE, 0)
    ...
    private val hideCamera = Prefs.getInt(IconTurner.CAMERA, 0)
    private val hideCar = Prefs.getInt(IconTurner.CAR, 0)
    private val hideGlasses = Prefs.getInt(IconTurner.GLASSES, 0)
    ...
    override fun onHook() {
        ...
        hideIcon(hideMobile, "mobile", statusBarList, controlList)
        hideIcon(hideMobile, "demo_mobile", statusBarList, controlList)
        ...
        hideIcon(hideWiFi, "demo_wifi", statusBarList, controlList)
        hideIcon(hideNoSim, "no_sim", statusBarList, controlList)
        hideIcon(hideNewHD, "hd", statusBarList, controlList)
        hideIcon(hideCamera, "camera", statusBarList, controlList)
        hideIcon(hideCar, "car", statusBarList, controlList)
        hideIcon(hideGlasses, "glasses", statusBarList, controlList)
