...
object NetworkSpeed : YukiBaseHooker() {
    ...
    private val typefaceNetSpeedNumberFW by lazy {
        Typeface.Builder(fontPath).setFontVariationSettings("'wght' $modifyNetSpeedNumberFW").build()
    }
    private val typefaceNetSpeedUnitFW by lazy {
        Typeface.Builder(fontPath).setFontVariationSettings("'wght' $modifyNetSpeedUnitFW").build()
    }
    private val typefaceNetSpeedSeparateFW by lazy {
        Typeface.Builder(fontPath).setFontVariationSettings("'wght' $modifyNetSpeedSeparateFW").build()
    }
