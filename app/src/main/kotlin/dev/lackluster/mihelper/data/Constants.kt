...
object Constants {
    ...
    val STATUS_BAR_ICONS_DEFAULT = listOf(
        ...
        "hd", "airplane", "mobile", "demo_mobile", IconSlots.STACKED_MOBILE_ICON, IconSlots.STACKED_MOBILE_TYPE, "no_sim", "wifi", "demo_wifi",
    )
    ...
    val STATUS_BAR_ICONS_SWAP = listOf(
        ...
        "hotspot", "sound_box_group", "stereo", "sound_box_screen", "sound_box", "wireless_headset",
        "zen", "volume", "dist_compute", "camera", "glasses", "car", "tv", "pc", "pad", "phone",
        "wifi", "demo_wifi", "hd", "airplane", "mobile", "demo_mobile", IconSlots.STACKED_MOBILE_ICON, IconSlots.STACKED_MOBILE_TYPE, "no_sim",
    )
    ...
    val STATUS_BAR_ICON_SLOT_MAP = mutableMapOf(
        ...
        IconSlots.STACKED_MOBILE_TYPE to StatusBarIconSlotWrap(IconSlots.STACKED_MOBILE_TYPE, R.drawable.ic_stat_sys_stacked_type, R.string.icon_tuner_stacked_mobile_type),
    )
