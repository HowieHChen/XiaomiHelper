...
//            const val CHAIN_START = "security_chain_start"
        ...
        object SystemUI {
            object StatusBar {
                const val CLOCK_PADDING_HORIZON = "statusbar_clock_padding_horizon"
                const val CLOCK_PADDING_START_VAL = "statusbar_clock_padding_start_val"
                const val CLOCK_PADDING_END_VAL = "statusbar_clock_padding_end_val"
                const val CLOCK_GEEK = "statusbar_clock_geek"
                const val CLOCK_GEEK_FORMAT_CLOCK = "statusbar_clock_pattern_clock"
                const val CLOCK_GEEK_FORMAT_PAD_CLOCK = "statusbar_clock_pattern_pad_clock"
                const val CLOCK_GEEK_FORMAT_BIG_TIME = "statusbar_clock_pattern_big_time"
                const val CLOCK_GEEK_FORMAT_DATE_TIME = "statusbar_clock_pattern_date_time"
                const val CLOCK_GEEK_FORMAT_CC_DATE = "statusbar_clock_pattern_cc_date"
                const val CLOCK_GEEK_FORMAT_HORIZON_TIME = "statusbar_clock_pattern_horizon_time"
            ...
            object FontWeight {
                ...
                const val PAD_CLOCK = "sb_font_pad_clock"
                const val PAD_CLOCK_WEIGHT = "sb_font_pad_clock_weight"
                const val BIG_TIME = "sb_font_big_time"
                const val BIG_TIME_WEIGHT = "sb_font_big_time_weight"
                const val DATE_TIME = "sb_font_date_time"
                const val DATE_TIME_WEIGHT = "sb_font_date_time_weight"
                const val CC_DATE = "sb_font_cc_date"
                const val CC_DATE_WEIGHT = "sb_font_cc_date_weight"
                const val HORIZONTAL_TIME = "sb_font_horizontal_time"
                const val HORIZONTAL_TIME_WEIGHT = "sb_font_horizontal_time_weight"
                const val LOCK_SCREEN_CARRIER = "sb_font_ls_carrier"
                const val LOCK_SCREEN_CARRIER_WEIGHT = "sb_font_ls_carrier_weight"
                const val NET_SPEED_NUMBER = "sb_font_speed_num"
                const val NET_SPEED_NUMBER_VAL = "sb_font_speed_num_weight"
                const val NET_SPEED_UNIT = "sb_font_speed_unit"
                const val NET_SPEED_UNIT_VAL = "sb_font_speed_unit_weight"
                const val NET_SPEED_SEPARATE = "sb_font_speed_separate"
                const val NET_SPEED_SEPARATE_VAL = "sb_font_speed_separate_weight"
                const val CELLULAR_TYPE = "sb_font_mobile_type"
                const val CELLULAR_TYPE_VAL = "sb_font_mobile_type_weight"
                const val CELLULAR_TYPE_SINGLE = "sb_font_mobile_type_single"
                const val CELLULAR_TYPE_SINGLE_VAL = "sb_font_mobile_type_single_weight"
                const val BATTERY_PERCENTAGE_IN = "sb_font_battery_pct_in"
                const val BATTERY_PERCENTAGE_IN_VAL = "sb_font_bat_pct_in_weight"
...
//                const val STACKED_MOBILE_TYPE = "sb_font_stacked_type_single"
            ...
            object IconTuner {
                ...
                const val HIDE_SIM_AUTO = "icon_tuner_hide_sim_auto"
                const val HIDE_SIM_ONE = "icon_tuner_hide_sim_one"
                const val HIDE_SIM_TWO = "icon_tuner_hide_sim_two"
                const val HIDE_CELLULAR_ACTIVITY = "icon_tuner_hide_cellular_activity"
                const val HIDE_CELLULAR_TYPE = "icon_tuner_hide_cellular_type"
                const val HIDE_CELLULAR_ROAM_GLOBAL = "icon_tuner_cellular_hide_roam_global"
                const val HIDE_CELLULAR_ROAM = "icon_tuner_cellular_hide_roam"
                const val HIDE_CELLULAR_SMALL_ROAM = "icon_tuner_cellular_hide_small_roam"
                const val HIDE_CELLULAR_VO_WIFI = "icon_tuner_cellular_hide_vo_wifi"
                const val HIDE_CELLULAR_VOLTE = "icon_tuner_cellular_hide_volte"
                const val HIDE_CELLULAR_VOLTE_NO_SERVICE = "icon_tuner_cellular_hide_volte_no_service"
                const val HIDE_CELLULAR_SPEECH_HD = "icon_tuner_cellular_hide_speech_hd"
                const val CELLULAR_TYPE_SINGLE = "icon_tuner_cellular_type_single"
                const val CELLULAR_TYPE_SINGLE_SWAP = "icon_tuner_cellular_type_single_swap"
                const val CELLULAR_TYPE_SINGLE_SIZE = "icon_tuner_cellular_type_single_size"
                const val CELLULAR_TYPE_SINGLE_SIZE_VAL = "icon_tuner_cellular_type_single_size_val"
                const val CELLULAR_TYPE_CUSTOM = "icon_tuner_cellular_type_custom"
                const val CELLULAR_TYPE_CUSTOM_VAL = "icon_tuner_cellular_type_custom_val"
                const val HIDE_WIFI_UNAVAILABLE = "icon_tuner_hide_wifi_unavailable"
                const val HIDE_WIFI_STANDARD = "icon_tuner_hide_wifi_type"
                const val HIDE_WIFI_ACTIVITY = "icon_tuner_hide_wifi_activity"
                const val WIFI_ACTIVITY_RIGHT = "icon_tuner_wifi_activity_right"
                const val BATTERY_STYLE = "icon_tuner_battery_style"
                const val BATTERY_STYLE_CC = "icon_tuner_battery_style_cc"
                const val HIDE_BATTERY_CHARGE_OUT = "icon_tuner_hide_charge_out"
                const val BATTERY_PERCENT_MARK_STYLE = "icon_tuner_battery_percent_mark_style"
                const val BATTERY_PERCENT_IN_SIZE = "icon_tuner_battery_percent_in_size"
                const val BATTERY_PERCENT_IN_SIZE_VAL = "icon_tuner_battery_percent_in_size_val"
                const val BATTERY_PERCENT_OUT_SIZE = "icon_tuner_change_battery_percent_out_size"
                const val BATTERY_PERCENT_OUT_SIZE_VAL = "icon_tuner_battery_percent_out_size_val"
                const val BATTERY_PADDING_HORIZON = "icon_tuner_battery_padding"
                ...
                const val WIFI = "icon_tuner_slot_wifi"
                const val HOTSPOT = "icon_tuner_slot_hotspot"
                const val VPN = "icon_tuner_slot_vpn"
                const val NET_SPEED = "icon_tuner_slot_net_speed"
                const val BLUETOOTH = "icon_tuner_slot_bluetooth"
                const val BLUETOOTH_BATTERY = "icon_tuner_slot_bluetooth_battery"
                const val HANDLE_BATTERY = "icon_tuner_slot_handle_battery"
                const val NFC = "icon_tuner_slot_nfc"
                const val LOCATION = "icon_tuner_slot_location"
                const val WIRELESS_HEADSET = "icon_tuner_slot_wireless_headset"
                const val PHONE = "icon_tuner_slot_phone"
                const val PAD = "icon_tuner_slot_pad"
                const val PC = "icon_tuner_slot_pc"
                const val SOUND_BOX_GROUP = "icon_tuner_slot_sound_box_group"
                const val STEREO = "icon_tuner_slot_stereo"
                const val SOUND_BOX_SCREEN = "icon_tuner_slot_sound_box_screen"
                const val SOUND_BOX = "icon_tuner_slot_sound_box"
                const val TV = "icon_tuner_slot_tv"
                const val GLASSES = "icon_tuner_slot_glasses"
                const val CAR = "icon_tuner_slot_car"
                const val CAMERA = "icon_tuner_slot_camera"
                const val DIST_COMPUTE = "icon_tuner_slot_dist_compute"
                const val HEADSET = "icon_tuner_slot_headset"
                const val ALARM_CLOCK = "icon_tuner_slot_alarm_clock"
                const val ZEN = "icon_tuner_slot_zen"
            ...
            object LockScreen {
                ...
                const val KEEP_CLOCK_CONTAINER = "systemui_ls_keep_clock"
            ...
            object NotifCenter {
                ...
                const val EXPAND_IGNORE_FOCUS = "systemui_notif_exp_ignore_focus"
                const val LAYOUT_RANK_OPT = "systemui_notif_layout_rank_opt"
...
//                const val ELM_ACTIONS_RESIZE = "media_elm_actions_resize"
            ...
            object Plugin {
                ...
                const val CONTROL_CENTER_HIDE_EDIT = "sys_plugin_cc_hide_edit"
            }
        }
...
//                const val ELM_ACTIONS_RESIZE = "di_media_elm_actions_resize"
    ...
    object DefValue {
        object SystemUI {
            const val CLOCK_GEEK_FORMAT_CLOCK = "H:mm"
            const val CLOCK_GEEK_FORMAT_PAD_CLOCK = "M d E"
            const val CLOCK_GEEK_FORMAT_BIG_TIME = "H:mm"
