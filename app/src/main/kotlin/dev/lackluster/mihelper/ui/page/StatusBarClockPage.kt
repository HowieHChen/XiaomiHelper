...
fun StatusBarClockPage(navController: NavController, adjustPadding: PaddingValues, mode: BasePageDefaults.Mode) {
    ...
    BasePage(
        ...
        itemPreferenceGroup(
            key = "general",
            titleResId = R.string.ui_title_clock_general,
            first = true
        ) {
            SwitchPreference(
        ...
        itemPreferenceGroup(
            key = "geek_mode",
            titleResId = R.string.ui_title_clock_geek_mode,
            visible = spValueGeekMode
        ) {
            EditTextPreference(
        ...
        itemPreferenceGroup(
            key = "easy_mode",
            titleResId = R.string.ui_title_clock_easy,
            visible = !spValueGeekMode
        ) {
            SwitchPreference(
        ...
        itemPreferenceGroup(
            key = "font_weight",
            titleResId = R.string.ui_title_clock_font_weight,
            last = true
        ) {
            SwitchPreference(
